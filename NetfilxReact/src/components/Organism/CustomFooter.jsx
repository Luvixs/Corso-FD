...
<>
    <Container>
        <div className=" d-flex flex-row text-bg-dark mt-5 justify-content-center">
            ...
            <ul className="list-unstyled mx-2">
                ...
                <li>Privacy</li>
                <li>Contact Us</li>
                <button type="button" className="btn btn-outline-light btn-sm mt-1">Service Code</button>
