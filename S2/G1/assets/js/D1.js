...
//string
let lettere = 'contenuto di tipo testo';
console.log(lettere);
//number
let weight = 5;
console.log(weight);
...
let und = undefined;
console.log(und);
//null  valore intenzialmente assente
let name= null;
console.log(null);
...
//persona = 'Ludovica Scalvini'; questa istruzione genera un errore di riassegnazione di valore a una constante
